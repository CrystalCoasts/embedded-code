...
//     Serial.println("Sending time: " + String(epochTime));  // Debug print
//     uint8_t* bytePtr = (uint8_t*)&epochTime;
    
//     while (!success && attempts < max_attempts) {
//         Wire.beginTransmission(slaveAddress);
//         Wire.write(command);
//         for (size_t i = 0; i < sizeof(epochTime); i++) {
...
//     }
//     if (!success) {
//         Serial.println("Failed to send time after several attempts.");
//     }
// }
